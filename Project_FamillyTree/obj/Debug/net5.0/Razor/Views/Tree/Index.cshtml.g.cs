#pragma checksum "D:\FPT\Sem8\PRN231\Project\ProjectTeam_TreeHouse\Project_FamillyTree\Views\Tree\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "49b1397f21392b85124743f733a70200508f60a8"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"49b1397f21392b85124743f733a70200508f60a8", @"/Views/Tree/Index.cshtml")]
...
<html>
    ...
    .sidebar {
        ...
        bo");
            WriteLiteral(@"rder-right: 1px solid black;
        float: left;
        /* Add this */
    }
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "49b1397f21392b85124743f733a70200508f60a811693", async() => {
                WriteLiteral(@"
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "49b1397f21392b85124743f733a70200508f60a813435", async() => {
                WriteLiteral(@"
    <div class=""header"">
  ...
  ");
        ...
        function addParent() {
            ...
            if (selectedNode) {
                ...
                var grandparentList = grand");
                WriteLiteral(@"parentNode.querySelector(""ul"");
                if (!grandparentList) {
        ...
        function addRelative(type) {
            ...
            if (selectedNode) {
                ...
                if (type === ""child"") {
                 ...
                 ");
                WriteLiteral(@"       selectedNode.parentNode.parentNode.appendChild(parentSiblingList);
                    }
        ...
        for (var i = 0; i < treeNodes.length; i++) {
            treeNodes[i].addEventListener(""click"", function () {
                var currentSelected = document.querySelector("".selected"");
                if (currentSelected) {
                    currentSelected.classList");
                WriteLiteral(@".remove(""selected"");
                }
